  ...
  <div>
    <div class="Notes col-4 offset-4" v-for="note in allNotes" :key="note.id">
      <div class="card mb-4 shadow">
        <div class="card-body"
          :class="note.flagged == 'pending' ? 'bg-light' : note.flagged == 'completed' ? 'bg-success' : 'bg-secondary'">
          ...
          <h6 v-show="note.flagged == 'pending'" v-if="activeLog.closed == false"><b>Change Status:</b> <a href=""
          ...
          <button class="btn btn-sm btn-outline-dark shadow delete-btn" v-if="activeLog.closed == false"
